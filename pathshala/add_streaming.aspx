<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="add_streaming.aspx.cs" Inherits="pathshala.add_streaming" %>
                                ...
                                <div class="tab-pane fade show active" id="add-straming" role="tabpanel">
                                    <div class="add_stream_content">
                                        ...
                                        <div class="live_form">
                                            ...
                                            <button class="_145d1"><i class='uil uil-video'></i>Go Live</button>
                                        </div>
                                    </div>
                                </div>

<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="instructor_profile_view.aspx.cs" Inherits="pathshala.instructor_profile_view" %>
                        ...
                        <div class="section3125 rpt145">
                            <div class="row">
                                ...
                                <div class="col-lg-5">
                                    ...
                                    <ul class="_bty149">
                                        <li>
                                            <button class="subscribe-btn btn500">Subscribe</button></li>
                                        <li>
                                            <button class="msg125 btn500">Message</button></li>
                                    </ul>
                                </div>
                            </div>
                        </div>

<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="setting.aspx.cs" Inherits="pathshala.setting" %>
                    ...
                    <div class="col-lg-12">
                        ...
                        <div class="setting_tabs">
                            <ul class="nav nav-pills mb-4" id="pills-tab" role="tablist">
                                ...
                                <li class="nav-item">
                                    <a class="nav-link" id="pills-bllingpayment-tab" data-toggle="pill" href="#pills-bllingpayment" role="tab" aria-selected="false">Your Address</a>
                                </li>
                        ...
                        <div class="tab-content" id="pills-tabContent">
                                ...
                                <div class="account_setting">
                                    <div class="basic_profile">
                                        <div class="basic_ptitle">
                                            <h4>Basic Profile</h4>
                                            <asp:Panel class="alert alert-info text-center" ID="id_PnResult" Visible="false" runat="server"></asp:Panel>
                                            <div class="row">
                                                <div class="col-lg-6">
                                                    <div class="ui search focus mt-30">
                                                        <div class="ui left icon input swdh11 swdh19">
                                                            <%--<input style="text-align: center" class="prompt srch_explore mb-3" type="text" name="name" value="" id="id_yourid" required="" maxlength="64" placeholder="Your Id">--%>
                                                            <label style="margin-top: 10px">Email*</label>
                                                            <asp:DropDownList ID="id_ddlBasicProfileEmail" CssClass="mb-3 ui hj145 dropdown cntry152 prompt srch_explore" runat="server" DataSourceID="id_DsSi" DataTextField="emailAddress" DataValueField="studentId"></asp:DropDownList>
                                                            <asp:SqlDataSource ID="id_DsSi" runat="server" ConnectionString="<%$ ConnectionStrings:pathshalaDBCon %>" SelectCommand="SELECT * FROM [tbl_SingUpStudent]"></asp:SqlDataSource>
                                                        </div>
                                                    </div>
                                                    <div style="margin-left: 134px">
                                                        <div class="view_img_right">
                                                            <div class="view__img">
                                                                <asp:Image CssClass=" img-thumbnail imgCoverPreview" Width="173px" Height="129px" ID="Image1" runat="server" />
                                                            </div>
                                                        </div>
                                                        <div class="view_img_right my-4 ">
                                                            <div class="upload__input">
                                                                <div class="input-group">
                                                                    <div class="custom-file">
                                                                        <asp:FileUpload ID="id_InstructorImage" CssClass="custom-file-input id_CoverImage2" runat="server" />
                                                ...
                                                <div class="col-lg-8">
                                                    <div class="row">
                                                        <div class="col-lg-6">
                                                            <div class="ui search focus mt-30">
                                                                <div class="ui left icon input swdh11 swdh19">
                                                                    <input runat="server" class="prompt srch_explore" type="text" name="name" value="" id="id_FirstName" required="" maxlength="64" placeholder="First Name">
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div class="col-lg-6">
                                                            <div class="ui search focus mt-30">
                                                                <div class="ui left icon input swdh11 swdh19">
                                                                    <input runat="server" class="prompt srch_explore" type="text" name="" value="" id="id_LastName" required="" maxlength="64" placeholder="Last Name">
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div class="col-lg-12">
                                                            <div class="ui search focus mt-30">
                                                                <div class="ui form swdh30">
                                                                    <div class="field">
                                                                        <textarea runat="server" rows="3" name="description" id="id_headline" placeholder="Write a little description about you..."></textarea>
                                                                    </div>
                                                                </div>
                                                        ...
                                                        <div class="col-lg-12">
                                                            <div class="ui search focus mt-30">
                                                                <div class="ui left icon labeled input swdh11 swdh31">
                                                                    ...
                                                                    <input runat="server" class="prompt srch_explore" type="text" name="site" value="" id="id_site" required="" maxlength="64" placeholder="yoursite.com">
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div class="col-lg-12">
                                                            <div class="ui search focus mt-30">
                                                                <div class="ui left icon labeled input swdh11 swdh31">
                                                                    ...
                                                                    <input runat="server" class="prompt srch_explore" type="text" name="facebooklink" id="id_facebook" required="" maxlength="64" placeholder="Facebook Profile">
                                                                </div>
                                                        ...
                                                        <div class="col-lg-12">
                                                            <div class="ui search focus mt-30">
                                                                <div class="ui left icon labeled input swdh11 swdh31">
                                                                    ...
                                                                    <input runat="server" class="prompt srch_explore" type="text" name="twitterlink" id="id_twitter" required="" maxlength="64" placeholder="Twitter Profile">
                                                                </div>
                                                        ...
                                                        <div class="col-lg-12">
                                                            <div class="ui search focus mt-30">
                                                                <div class="ui left icon labeled input swdh11 swdh31">
                                                                    ...
                                                                    <input runat="server" class="prompt srch_explore" type="text" name="linkedinlink" id="id_linkedin" required="" maxlength="64" placeholder="Linkedin Profile">
                                                                </div>
                                                        ...
                                                        <div class="col-lg-12">
                                                            <div class="ui search focus mt-30">
                                                                <div class="ui left icon labeled input swdh11 swdh31">
                                                                    ...
                                                                    <input runat="server" class="prompt srch_explore" type="text" name="youtubelink" id="id_youtube" required="" maxlength="64" placeholder="Youtube Profile">
                                                                </div>
                                    ...
                                    <button runat="server" id="id_btnProfileSave" onserverclick="id_btnProfileSave_ServerClick" class="save_btn" type="submit">Save Changes</button>
                                </div>
                                <asp:UpdatePanel ID="UpdatePanel2" runat="server">
                                    <ContentTemplate>

                                        <asp:DetailsView CssClass="table table-bordered" ID="DetailsView1" runat="server" Height="50px" Width="702px" AllowPaging="True" AutoGenerateRows="False" BackColor="White" BorderColor="#999999" BorderStyle="None" BorderWidth="1px" CellPadding="3" DataSourceID="ObjectDataSource1" GridLines="Vertical">
                                            <AlternatingRowStyle BackColor="#DCDCDC" />
                                            <EditRowStyle BackColor="#008A8C" Font-Bold="True" ForeColor="White" />
                                            <Fields>
                                                <asp:TemplateField HeaderText="Profile Student Id" SortExpression="basicProfileStudentId">
                                                    <EditItemTemplate>
                                                        <asp:Label CssClass="form-control" ID="Label11" runat="server" Text='<%# Bind("basicProfileStudentId") %>'></asp:Label>
                                                    </EditItemTemplate>
                                                    <InsertItemTemplate>
                                                        <asp:TextBox ID="TextBox11" runat="server" Text='<%# Bind("basicProfileStudentId") %>'></asp:TextBox>
                                                    </InsertItemTemplate>
                                                    <ItemTemplate>
                                                        <asp:Label CssClass="form-control bg-dark text-white" ID="Label11" runat="server" Text='<%# Bind("basicProfileStudentId") %>'></asp:Label>
                                                    </ItemTemplate>
                                                </asp:TemplateField>
                                                <asp:TemplateField HeaderText="Student Id" SortExpression="studentId">
                                                    <EditItemTemplate>
                                                        <asp:Label CssClass="form-control" ID="Label10" runat="server" Text='<%# Bind("studentId") %>'></asp:Label>
                                                    </EditItemTemplate>
                                                    <InsertItemTemplate>
                                                        <asp:TextBox ID="TextBox10" runat="server" Text='<%# Bind("studentId") %>'></asp:TextBox>
                                                    </InsertItemTemplate>
                                                    <ItemTemplate>
                                                        <asp:Label CssClass="form-control bg-dark text-white" ID="Label10" runat="server" Text='<%# Bind("studentId") %>'></asp:Label>
                                                    </ItemTemplate>
                                                </asp:TemplateField>
                                                <asp:TemplateField HeaderText="Student Image" SortExpression="InstructorImage">
                                                    <EditItemTemplate>
                                                        <asp:TextBox ID="TextBox9" runat="server" Text='<%# Bind("InstructorImage") %>'></asp:TextBox>
                                                        <asp:Image ID="Image2" CssClass="img-rounded imghello" Width="50" ImageUrl='<%# Eval("InstructorImage", "~/StudentImage/{0}") %>' runat="server" />
                                                        <asp:FileUpload ID="id_CoverIma" CssClass="custom-control-label" runat="server" />
                                                    </EditItemTemplate>
                                                    <InsertItemTemplate>
                                                        <asp:TextBox ID="TextBox9" runat="server" Text='<%# Bind("InstructorImage") %>'></asp:TextBox>
                                                    ...
                                                    <ItemTemplate>
                                                        ...
                                                        <asp:Image ID="Image2" CssClass="img-rounded" Width="50" ImageUrl='<%# Eval("InstructorImage", "~/StudentImage/{0}") %>' runat="server" />
                                                    </ItemTemplate>
                                                </asp:TemplateField>
                                                <asp:TemplateField HeaderText="First Name" SortExpression="firstName">
                                                    <EditItemTemplate>
                                                        <asp:TextBox CssClass="form-control" ID="TextBox8" runat="server" Text='<%# Bind("firstName") %>'></asp:TextBox>
                                                    </EditItemTemplate>
                                                    <InsertItemTemplate>
                                                        <asp:TextBox ID="TextBox8" runat="server" Text='<%# Bind("firstName") %>'></asp:TextBox>
                                                    </InsertItemTemplate>
                                                    <ItemTemplate>
                                                        <asp:Label CssClass="form-control bg-dark text-white" ID="Label8" runat="server" Text='<%# Bind("firstName") %>'></asp:Label>
                                                    </ItemTemplate>
                                                </asp:TemplateField>
                                                <asp:TemplateField HeaderText="Last Name" SortExpression="lastName">
                                                    <EditItemTemplate>
                                                        <asp:TextBox CssClass="form-control" ID="TextBox7" runat="server" Text='<%# Bind("lastName") %>'></asp:TextBox>
                                                    </EditItemTemplate>
                                                    <InsertItemTemplate>
                                                        <asp:TextBox ID="TextBox7" runat="server" Text='<%# Bind("lastName") %>'></asp:TextBox>
                                                    </InsertItemTemplate>
                                                    <ItemTemplate>
                                                        <asp:Label CssClass="form-control bg-dark text-white" ID="Label7" runat="server" Text='<%# Bind("lastName") %>'></asp:Label>
                                                    </ItemTemplate>
                                                </asp:TemplateField>
                                                <asp:TemplateField HeaderText="About You" SortExpression="aboutYourSelf">
                                                    <EditItemTemplate>
                                                        <asp:TextBox CssClass="form-control" ID="TextBox6" runat="server" Text='<%# Bind("aboutYourSelf") %>'></asp:TextBox>
                                                    </EditItemTemplate>
                                                    <InsertItemTemplate>
                                                        <asp:TextBox ID="TextBox6" runat="server" Text='<%# Bind("aboutYourSelf") %>'></asp:TextBox>
                                                    </InsertItemTemplate>
                                                    <ItemTemplate>
                                                        <asp:Label CssClass="form-control bg-dark text-white" ID="Label6" runat="server" Text='<%# Bind("aboutYourSelf") %>'></asp:Label>
                                                    </ItemTemplate>
                                                </asp:TemplateField>
                                                <asp:TemplateField HeaderText="Website" SortExpression="ws">
                                                    <EditItemTemplate>
                                                        <asp:TextBox CssClass="form-control" ID="TextBox5" runat="server" Text='<%# Bind("ws") %>'></asp:TextBox>
                                                    </EditItemTemplate>
                                                    <InsertItemTemplate>
                                                        <asp:TextBox ID="TextBox5" runat="server" Text='<%# Bind("ws") %>'></asp:TextBox>
                                                    </InsertItemTemplate>
                                                    <ItemTemplate>
                                                        <asp:Label CssClass="form-control bg-dark text-white" ID="Label5" runat="server" Text='<%# Bind("ws") %>'></asp:Label>
                                                    </ItemTemplate>
                                                </asp:TemplateField>
                                                <asp:TemplateField HeaderText="Facebook" SortExpression="fb">
                                                    <EditItemTemplate>
                                                        <asp:TextBox CssClass="form-control" ID="TextBox4" runat="server" Text='<%# Bind("fb") %>'></asp:TextBox>
                                                    </EditItemTemplate>
                                                    <InsertItemTemplate>
                                                        <asp:TextBox ID="TextBox4" runat="server" Text='<%# Bind("fb") %>'></asp:TextBox>
                                                    </InsertItemTemplate>
                                                    <ItemTemplate>
                                                        <asp:Label ID="Label4" CssClass="form-control bg-dark text-white" runat="server" Text='<%# Bind("fb") %>'></asp:Label>
                                                    </ItemTemplate>
                                                </asp:TemplateField>
                                                <asp:TemplateField HeaderText="Twitter" SortExpression="tw">
                                                    <EditItemTemplate>
                                                        <asp:TextBox CssClass="form-control" ID="TextBox3" runat="server" Text='<%# Bind("tw") %>'></asp:TextBox>
                                                    </EditItemTemplate>
                                                    <InsertItemTemplate>
                                                        <asp:TextBox ID="TextBox3" runat="server" Text='<%# Bind("tw") %>'></asp:TextBox>
                                                    </InsertItemTemplate>
                                                    <ItemTemplate>
                                                        <asp:Label CssClass="form-control bg-dark text-white" ID="Label3" runat="server" Text='<%# Bind("tw") %>'></asp:Label>
                                                    </ItemTemplate>
                                                </asp:TemplateField>
                                                <asp:TemplateField HeaderText="LinkDin" SortExpression="li">
                                                    <EditItemTemplate>
                                                        <asp:TextBox CssClass="form-control" ID="TextBox2" runat="server" Text='<%# Bind("li") %>'></asp:TextBox>
                                                    </EditItemTemplate>
                                                    <InsertItemTemplate>
                                                        <asp:TextBox ID="TextBox2" runat="server" Text='<%# Bind("li") %>'></asp:TextBox>
                                                    </InsertItemTemplate>
                                                    <ItemTemplate>
                                                        <asp:Label ID="Label2" CssClass="form-control bg-dark text-white" runat="server" Text='<%# Bind("li") %>'></asp:Label>
                                                    </ItemTemplate>
                                                </asp:TemplateField>
                                                <asp:TemplateField HeaderText="YouTube" SortExpression="yt">
                                                    <EditItemTemplate>
                                                        <asp:TextBox CssClass="form-control" ID="TextBox1" runat="server" Text='<%# Bind("yt") %>'></asp:TextBox>
                                                    </EditItemTemplate>
                                                    <InsertItemTemplate>
                                                        <asp:TextBox ID="TextBox1" runat="server" Text='<%# Bind("yt") %>'></asp:TextBox>
                                                    </InsertItemTemplate>
                                                    <ItemTemplate>
                                                        <asp:Label CssClass="form-control bg-dark text-white" ID="Label1" runat="server" Text='<%# Bind("yt") %>'></asp:Label>
                                                    </ItemTemplate>
                                                </asp:TemplateField>
                                                <asp:TemplateField ShowHeader="False">
                                                    <EditItemTemplate>
                                                        <div class="text-center">
                                                            <asp:LinkButton CssClass="btn btn-warning" ID="LinkButton1" runat="server" CausesValidation="True" CommandName="Update" Text="Update"></asp:LinkButton>
                                                            &nbsp;<asp:LinkButton CssClass="btn btn-dark" ID="LinkButton2" runat="server" CausesValidation="False" CommandName="Cancel" Text="Cancel"></asp:LinkButton>
                                                        </div>
                                                    </EditItemTemplate>
                                                    <ItemTemplate>
                                                        <div class="text-center">
                                                            <asp:LinkButton Width="175px" CssClass="btn btn-primary" ID="LinkButton1" runat="server" CausesValidation="False" CommandName="Edit" Text="Edit"></asp:LinkButton>
                                                        </div>
                                                    </ItemTemplate>
                                                </asp:TemplateField>
                                            </Fields>
                                        ...
                                        <asp:ObjectDataSource ID="ObjectDataSource1" runat="server" DataObjectTypeName="pathshala.ObjectData.basicProfileStudent" DeleteMethod="DeleteCategory" InsertMethod="InsertCategory" SelectMethod="GetCategories" TypeName="pathshala.ObjectData.ObjectStudent" UpdateMethod="UpdateCategory"></asp:ObjectDataSource>
                                    </ContentTemplate>
                                </asp:UpdatePanel>
                            </div>
                                        ...
                                        <div class="basic_form">
                                            <div class="nstting_content">
                                                <div class="basic_ptitle">
                                                    ...
                                                    <p>Your emails are sent to <a href="https://gambolthemes.net/cdn-cgi/l/email-protection" class="__cf_email__" data-cfemail="bddadcd0dfd2d184898efddad0dcd4d193ded2d093">[email&#160;protected]</a> To unsubscribe from an email, click the "Unsubscribe" link at the bottom of it. <a href="#">Learn more</a> about emails from Pathshala.</p>
                                                </div>
                                                <div class="ui toggle checkbox _1457s2">
                                                    <input type="checkbox" name="stream_ss5" checked>
                                                    <label>Send me emails about my Pathshala activity and updates I requested</label>
                                                    <p class="ml5">If this setting is turned off, Pathshala may still send you messages regarding your account, required service announcements, legal notifications, and privacy matters</p>
                                                </div>
                                                <div class="ui toggle checkbox _1457s2">
                                                    <input type="checkbox" name="stream_ss6">
                                                    <label>Promotions, course recommendations, and helpful resources from Pathshala.</label>
                                                </div>
                                                <div class="ui toggle checkbox _1457s2">
                            ...
                            <div class="tab-pane fade" id="pills-closeaccount" role="tabpanel" aria-labelledby="pills-closeaccount-tab">
                                <div class="account_setting">
                                    <h4>Close account</h4>
                                    <p><strong>Warning:</strong> If you close your account, you will be unsubscribed from all your courses, and will lose access forever.</p>
                                </div>
                                <asp:UpdatePanel ID="UpdatePanel1" runat="server">
                                    <ContentTemplate>
                                        <div class="alert alert-link mt-3 ">
                                    <asp:Label ID="id_msgAccountClose" Visible="false" Text="Message" runat="server" />
                                </div>
                                        <div class="row">
                                            <div class="col-lg-4">
                                                <div class="ui search focus">
                                                    <div class="ui left icon input swdh11 swdh19">
                                                        <input runat="server" class="prompt srch_explore" type="text" name="youremail" id="id_emailbt" maxlength="64" placeholder="Enter Email">
                                                    </div>
                                                    &nbsp;
                                            <div class="ui left icon input swdh11 swdh19">
                                                <input runat="server" class="prompt srch_explore" type="password" name="yourassword" id="id_yourpassword" required="" maxlength="64" placeholder="Enter Your Password">
                                            </div>
                                                    <div class="help-block">Are you sure you want to close your account?</div>
                                                </div>
                                                <asp:UpdateProgress ID="UpdateProgress1" runat="server">
                                                    <ProgressTemplate>
                                                        <img style="margin-left: 13px; margin-top: 5px;" src="AjazProcessImage/Bean%20Eater.gif" />
                                                    </ProgressTemplate>
                                                </asp:UpdateProgress>
                                                <asp:Button runat="server" UseSubmitBehavior="false" CssClass="save_payout_btn mbs20" ID="id_btnAccountClose" OnClick="id_btnAccountClose_Click" Text="Close Account" />
                                            </div>
                                        </div>
...
<asp:Content ID="Content3" runat="server" ContentPlaceHolderID="footContainer">
    <script type="text/javascript">
        $('#mainContent_id_InstructorImage').change(function (event) {
            var tmppath = URL.createObjectURL(event.target.files[0]);
            $(".imgCoverPreview").fadeIn("fast").attr('src', URL.createObjectURL(event.target.files[0]));
        });
        $('#ContentPlaceHolder1_id_CoverIma').change(function (event) {
            var tmppath = URL.createObjectURL(event.target.files[0]);
            $(".imghello").fadeIn("fast").attr('src', URL.createObjectURL(event.target.files[0]));
        });
    </script>
</asp:Content>

<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="sign_in.aspx.cs" Inherits="pathshala.Instructor.sign_in" %>
        ...
        <div class="container">
            <div class="row justify-content-lg-center justify-content-md-center">
                ...
                <div class="col-lg-6 col-md-8">
                    <div class="sign_form">
                        <h2>Welcome Back</h2>
                        <p>Log In to Your Pathshala Account For Instructor</p>
                            ...
                            <asp:UpdatePanel ID="UpdatePanel1" runat="server">
                                <ContentTemplate>
                                    ...
                                    <asp:UpdateProgress DynamicLayout="true" DisplayAfter="300" ID="UpdateProgress1" runat="server">
                                        <ProgressTemplate>
                                            <img style="width:50px" src="../AjazProcessImage/process1.gif" />
                                        </ProgressTemplate>
                                    </asp:UpdateProgress>

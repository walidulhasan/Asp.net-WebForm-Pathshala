<%@ Page Title="" Language="C#" MasterPageFile="~/Instructor/instructor.Master" AutoEventWireup="true" CodeBehind="setting.aspx.cs" Inherits="pathshala.Instructor.setting" %>
                    ...
                    <div class="col-lg-12">
                        ...
                        <div class="setting_tabs">
                            <ul class="nav nav-pills mb-4" id="pills-tab" role="tablist">
                                ...
                                <li class="nav-item">
                                    <a class="nav-link" id="id_Address" data-toggle="pill" href="#id_Addresstab" role="tab" aria-selected="true">Address</a>
                                </li>
                                <li class="nav-item">
                        ...
                        <div class="tab-content" id="pills-tabContent">
                                    <div class="tab-pane fade show active" id="pills-account" role="tabpanel" aria-labelledby="pills-account-tab">
                                        <div class="account_setting">
                                            <h4>Your Pathshala Account</h4>
                                            <p>This is your public presence on Pathshala. You need a account to upload your paid courses, comment on courses, purchased by students, or earning.</p>
                                                        ...
                                                        <div class="col-lg-6">
                                                            <div class="ui search focus mt-30">
                                                                <div class="ui left icon input swdh11 swdh19">
                                                                    ...
                                                                    <asp:DropDownList ID="id_ddlBasicProfileEmail" CssClass="mb-3 ui hj145 dropdown cntry152 prompt srch_explore" runat="server" DataSourceID="id_DsIs" DataTextField="emailAddress" DataValueField="instructorId"></asp:DropDownList>
                                                                    <asp:SqlDataSource ID="id_DsIs" runat="server" ConnectionString="<%$ ConnectionStrings:pathshalaDBCon %>" SelectCommand="SELECT * FROM [tbl_SingUpInstructor]"></asp:SqlDataSource>
                                                                </div>
                                                            </div>
                                                            <div style="margin-left: 144px">
                                                                <div class="view_img_right">
                                                                    <div class="view__img">
                                                                        <asp:Image CssClass="img-bx imgCoverPreview" Width="173px" Height="129px" ID="Image1" runat="server" />
                                                                    </div>
                                                                </div>
                                                        ...
                                                        <div class="col-lg-8">
                                                            <div class="row">
                                                                ...
                                                                <div class="col-lg-6">
                                                                    <div class="ui search focus mt-30">
                                                                        <div class="ui left icon input swdh11 swdh19">
                                                                            <input runat="server" class="prompt srch_explore" type="text" name="surname" value="" id="id_LastName" required="" maxlength="64" placeholder="Last Name">
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                                <div class="col-lg-12">
                                                                    <div class="ui search focus mt-30">
                                                                        <div class="ui left icon input swdh11 swdh19">
                                                                            <input runat="server" class="prompt srch_explore" type="text" name="headline" value="" id="id_headline" required="" maxlength="60" placeholder="Headline">
                                                                            <div class="form-control-counter" data-purpose="form-control-counter">36</div>
                                                                        </div>
                                                                        <div class="help-block">Add a professional headline like, "Engineer at Pathshala" or "Architect."</div>
                                                                    </div>
                                                                </div>
                                                                <div class="col-lg-12">
                                                                    <div class="ui search focus mt-30">
                                                                        <div class="ui form swdh30">
                                                                            <div class="field">
                                                                                <textarea rows="3" runat="server" name="description" id="id_about" placeholder="Write a little description about you..."></textarea>
                                                                            </div>
                                                                        </div>
                                            ...
                                            <%--<asp:Button ID="id_btnBasicProfielSave" OnClick="id_btnBasicProfielSave_Click" CssClass="save_btn" runat="server" Text="Save Profile" />--%>
                                        </div>
                                    </div>
                            <div class="tab-pane fade" id="id_Addresstab" role="tabpanel" aria-labelledby="pills-bllingpayment-tab">
                                <div class="account_setting">
                                    <div class="basic_form">
                                        <div class="row">
                                            <div class="col-lg-8">
                                        ...
                                        <div class="row">
                                            <div class="col-lg-12">
                                                ...
                                                <div class="rpt100 mt-30">
                                                    <div class="ui left icon input swdh11 swdh19">
                                                        <input class="prompt srch_explore" type="text" name="yourassword" id="id_yourIdBill" required="" maxlength="64" placeholder="Enter Your Id">
                                                    </div>
                            ...
                            <div class="tab-pane fade" id="pills-api" role="tabpanel" aria-labelledby="pills-api-tab">
                                <div class="account_setting">
                                    <h4>Affiliate API</h4>
                                    <p>
                                        The Pathshala Affiliate API exposes functionalities of Pathshala to help developers build client applications and integrations with Pathshala.
                                        <br>
                                        To see more details, please visit <a href="#">Edututs Affiliate API</a>
                                    </p>
                                </div>
                            ...
                            <div class="tab-pane fade" id="pills-closeaccount" role="tabpanel" aria-labelledby="pills-closeaccount-tab">
                                ...
                                <div class="row">
                                    <div class="col-lg-4">
                                        <div class="ui search focus mt-30">
                                            <div class="ui left icon input swdh11 swdh19">
                                                <input class="prompt srch_explore" type="text" name="yourassword" id="id_yourId" required="" maxlength="64" placeholder="Enter Your Email">
                                            </div>
                                            &nbsp;
                                            <div class="ui left icon input swdh11 swdh19">
...
<asp:Content ID="Content3" runat="server" ContentPlaceHolderID="foot">
    <script type="text/javascript">
        $('#ContentPlaceHolder1_id_InstructorImage').change(function (event) {

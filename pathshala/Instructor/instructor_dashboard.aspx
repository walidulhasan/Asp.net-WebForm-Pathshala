<%@ Page Title="" Language="C#" MasterPageFile="~/Instructor/instructor.Master" AutoEventWireup="true" CodeBehind="instructor_dashboard.aspx.cs" Inherits="pathshala.Instructor.instructor_dashboard" %>
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                                ...
                                <div class="owl-carousel edututs_news owl-theme">
                                    ...
                                    <div class="item">
                                        <div class="fcrse_1">
                                            ...
                                            <div class="fcrse_content">
                                                <a href="#" class="crsedt145 mt-15">Watch: Pathshala interview Mr. Joginder</a>
                    ...
                    <div class="col-xl-4 col-lg-6 col-md-6">
                        ...
                        <div class="section3125 mt-50">
                            <h4 class="item_title">What's new in Pathshala</h4>
                            <div class="la5lo1">
                                <div class="fcrse_1">
                                    <div class="fcrse_content">

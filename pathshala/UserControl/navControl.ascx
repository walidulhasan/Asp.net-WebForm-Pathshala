<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="navControl.ascx.cs" Inherits="pathshala.UserControl.navControl" %>
<nav class="vertical_nav">
            <div class="left_section menu_left" id="js-menu">
                <div class="left_section">
                    <ul>
                        <li class="menu--item">
                            <a href="Default.aspx"  class="menu--link active" title="Home">
                                <i class='uil uil-home-alt menu--icon'></i>
                                <span class="menu--label">Home</span>
                            </a>
                        </li>
                        <li class="menu--item">
                            <a href="live_streams.aspx" class="menu--link" title="Live Streams">
                                <i class='uil uil-kayak menu--icon'></i>
                                <span class="menu--label">Live Streams</span>
                            </a>
                        </li>
                        <li class="menu--item">
                            <a href="explore.aspx" class="menu--link" title="Explore">
                                <i class='uil uil-search menu--icon'></i>
                                <span class="menu--label">Explore</span>
                            </a>
                        </li>
                        <li class="menu--item">
                            <a href="liked_courses.aspx" class="menu--link" title="Liked Courses">
                                <i class='uil uil-thumbs-up menu--icon'></i>
                                <span class="menu--label">Liked Courses</span>
                            </a>
                        </li>
                        <li class="menu--item">
                            <a href="categories.aspx" class="menu--link" title="Categories">
                        ...
                        <li class="menu--item">
                            <a href="history.aspx" class="menu--link" title="History">
                                <i class='uil uil-history menu--icon'></i>
                                <span class="menu--label">History</span>
                            </a>
                        </li>
                        <li class="menu--item">
                            <a href="watch_later.aspx" class="menu--link" title="Watch Later">
                        ...
                        <li class="menu--item  menu--item__has_sub_menu">
                            ...
                            <ul class="sub_menu">
                                ...
                                <li class="sub_menu--item">
                                    <a href="course_detail_view.aspx" class="sub_menu--link">Course Detail View</a>
                                </li>
                                <li class="sub_menu--item">
                                ...
                                <li class="sub_menu--item">
                                    <a href="live_output.aspx" class="sub_menu--link">Live Stream View</a>
                                </li>
                                <li class="sub_menu--item">
                                    <a href="add_streaming.aspx" class="sub_menu--link">Add live Stream</a>
                                </li>
                                <li class="sub_menu--item">
                ...
                <div class="left_section">
                    ...
                    <ul>
                        ...
                        <li class="menu--item">
                            <a href="all_instructor.aspx" class="menu--link" title="Browse Instructors">
                ...
                <div class="left_section pt-2">
                    <ul>
                        <li class="menu--item">
                            <a href="setting.aspx" class="menu--link" title="Setting">
                                <i class='uil uil-cog menu--icon'></i>
                                <span class="menu--label">Setting</span>
                            </a>
                        </li>
                        <%--<li class="menu--item">
                            <a href="help.aspx" class="menu--link" title="Help">
                                <i class='uil uil-question-circle menu--icon'></i>
                                <span class="menu--label">Help</span>
                            </a>
                        </li>--%>
                        <li class="menu--item">
                            <a href="report_history.aspx" class="menu--link" title="Report History">
                                <i class='uil uil-windsock menu--icon'></i>
                                <span class="menu--label">Report History</span>
                            </a>
                        </li>
                        <li class="menu--item">
                            <a href="feedback.aspx" class="menu--link" title="Send Feedback">
                                <i class='uil uil-comment-alt-exclamation menu--icon'></i>
                                <span class="menu--label">Send Feedback/Help</span>
                            </a>
                        </li>
                    </ul>
                </div>
                <div class="left_footer">
                    ...
                    <div class="left_footer_content">
                        <p>© 2020 <strong>Pathshala</strong>. All Rights Reserved.</p>
                    </div>
                </div>
            </div>
        </nav>
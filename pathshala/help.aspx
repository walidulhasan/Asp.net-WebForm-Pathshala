<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="help.aspx.cs" Inherits="pathshala.help" %>
                                ...
                                <div class="tab-pane fade show active" id="nav-instructor" role="tabpanel">
                                    ...
                                    <div class="tpc152">
                                        ...
                                        <div class="section3126 mt-20">
                                            <div class="row">
                                                <div class="col-md-4">
                                                    <a href="#" class="value_props51">Promote Your Course With Coupons and Referral Links
</a>
                                                </div>
                                                <div class="col-md-4">
                                                    <a href="#" class="value_props51">How to Select Your Payout Method And Become a Premium Instructor
</a>
                                                </div>
                                                <div class="col-md-4">
                                                    <a href="#" class="value_props51">Pathshala Course Quality Checklist
</a>
                                                </div>
                                                <div class="col-md-4">
                                                    <a href="#" class="value_props51">Instructor Revenue Share
</a>
                                                </div>
                                                <div class="col-md-4">
                                                    <a href="#" class="value_props51">Instructor Promotional Agreements and Pathshala Deals
</a>
                                                </div>
                                                <div class="col-md-4">
                                                    <a href="#" class="value_props51">How to Become an Instructor: FAQ
</a>
                                                </div>
                                            </div>
                                        </div>
                                ...
                                <div class="tab-pane fade" id="nav-student" role="tabpanel">
                                                ...
                                                <div class="col-md-4">
                                                    <a href="#" class="value_props50">
                                                        ...
                                                        <div class="value_content">
                                                            ...
                                                            <p>Learn how Pathshala works and how to start learning.</p>
                                                        </div>
                                                    </a>
                                                </div>
                                                <div class="col-md-4">
                                    ...
                                    <div class="tpc152">
                                        ...
                                        <div class="section3126 mt-20">
                                            <div class="row">
                                                <div class="col-md-4">
                                                    <a href="#" class="value_props51">Lifetime Access
</a>
                                                </div>
                                                <div class="col-md-4">
                                                    <a href="#" class="value_props51">Pathshala FAQ
</a>
                                                </div>
                                                <div class="col-md-4">
                                                    <a href="#" class="value_props51">Downloading Courses
</a>
                                                </div>
                                                <div class="col-md-4">
                                                    <a href="#" class="value_props51">Certificate of Completion
</a>
                                                </div>
                                                <div class="col-md-4">
                                                    <a href="#" class="value_props51">Refund a Course
</a>
                                                </div>
                                                <div class="col-md-4">
                                                    <a href="#" class="value_props51">How to Solve Payment Issues
</a>
                                                </div>
                                            </div>
                                        </div>

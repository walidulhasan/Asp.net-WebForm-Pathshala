<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="my_instructor_profile_view.aspx.cs" Inherits="pathshala.my_instructor_profile_view" %>
                        ...
                        <div class="section3125 rpt145">
                            <div class="row">
                                <div class="col-lg-7">
                                    ...
                                    <div class="dp_dt150">
                                        <div class="img148">
                                            <img src="images/left-imgs/img-10.png" alt="">
                                        </div>
                                        <div class="prfledt1">
                                            <h2>Boni Amin</h2>
                                ...
                                <div class="col-lg-5">
                                    ...
                                    <ul class="_bty149">
                                        <li>
                                            <button class="studio-link-btn btn500" onclick="window.location.href = '#';">Edututs Studio</button></li>
                                        <li>
                                            <button class="msg125 btn500" onclick="window.location.href = '#';">Edit</button></li>
                                    </ul>
                                </div>
                            </div>
                        </div>
                                                ...
                                                <div class="col-lg-3 col-md-4">
                                                    <div class="fcrse_1 mt-30">
                                                        ...
                                                        <div class="tutor_content_dt">
                                                            ...
                                                            <ul class="tutor_social_links">
                                                                <li>
                                                                    <button class="sbbc145">Subscribed</button></li>
                                                                <li>
                                                                    <button class="sbbc146"><i class="uil uil-bell"></i></button>
                                                                </li>
                                                            </ul>
                                                            <div class="tut1250">

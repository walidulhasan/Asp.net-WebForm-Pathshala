<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="course_detail_view.aspx.cs" Inherits="pathshala.course_detail_view" %>
                        ...
                        <div class="section3125">
                            <div class="row">
                                <div class="col-xl-4 col-lg-5 col-md-6">
                                    <div class="preview_video">
                                        <a href="#" class="fcrse_img" data-toggle="modal" data-target="#videoModal">
                                            <%--<img runat="server"   id="id_CrouseImage" src="images/courses/img-2.jpg" alt="">--%>
                                ...
                                <div class="col-xl-8 col-lg-7 col-md-6">
                                    <div class="_215b03">
                                        <h2 runat="server" id="id_CrouseTitle"></h2>
                                        <span runat="server" id="id_courseDescription" class="_215b04"></span>
                                    </div>
                                    <div class="_215b05">
                                    ...
                                    <div class="_215b06">
                                        <div class="_215b07">
                                           ...
                                           <span runat="server" id="id_language"></span>
                                        </div>
                                        <div class="_215b08">
                                            <span><i class='uil uil-closed-captioning'></i></span>
                                            <span>English, Dutch
                                                <span class="caption_tooltip">12 more
                                    ...
                                    <div class="_215b05">
                                        Last updated <%= DateTime.Now.Day %> Days Ago 
                                    </div>
                                    <ul class="_215b31">
                                        <li>
                                            <button class="btn_adcart">Add to Cart</button></li>
                                        <li>
                                            <button class="btn_buy">Buy Now</button></li>
                                    </ul>
                                    <div class="_215fgt1">

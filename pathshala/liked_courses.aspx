<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="liked_courses.aspx.cs" Inherits="pathshala.liked_courses" %>
                            ...
                            <div class="preview_video">
                                <a href="#" class="fcrse_img" data-toggle="modal" data-target="#videoModal">
                                    ...
                                    <div class="course-overlay">
                                        <span class="_215b02">Play All Preview</span>
                                    </div>
                                </a>
                            </div>
                            <div class="grp_titles">
                                <div class="ht_title">Liked Courses</div>
                                <a href="#" class="ht_clr">Remove All</a>
                            </div>
                            <div class="tb_145">
                                <div class="wtch125">
                                    <span class="vdt14">4 Courses</span>
                                    <span class="vdt14">Last updated on Feb 29, 2020</span>
                                </div>
                                <a href="#" class="rmv-btn"><i class='uil uil-trash-alt'></i>Remove Liked Courses</a>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-8">
                        <div class="_14d25 mb-20">
                            <div class="row">
                                <div class="col-md-12">
                                    <h4 class="mhs_title">Liked Courses</h4>
                                    <div class="fcrse_1">
                                        <a href="course_detail_view.aspx" class="hf_img">
                                            <img src="images/courses/img-1.jpg" alt="">
                                            <div class="course-overlay">
                                        ...
                                        <div class="hs_content">
                                            ...
                                            <a href="course_detail_view.aspx" class="crse14s title900">Complete Python Bootcamp: Go from zero to hero in Python 3</a>
                                    ...
                                    <div class="fcrse_1 mt-30">
                                        ...
                                        <div class="hs_content">
                                            ...
                                            <a href="course_detail_view.aspx" class="crse14s title900">The Complete JavaScript Course 2020: Build Real Projects!</a>
                                    ...
                                    <div class="fcrse_1 mt-30">
                                        ...
                                        <div class="hs_content">
                                            ...
                                            <a href="course_detail_view.aspx" class="crse14s title900">Beginning C++ Programming - From Beginner to Beyond</a>
                                    ...
                                    <div class="fcrse_1 mt-30">
                                        ...
                                        <div class="hs_content">
                                            ...
                                            <a href="course_detail_view.aspx" class="crse14s title900">The Complete Digital Marketing Course - 12 Courses in 1</a>
